...
+     "layer": "apple-google-master",
+     "parent": "<g clip-path=\"url(#reward-84-554)\"><text x=\"634\" y=\"597\" text-anchor=\"end\" font-family=\"'Noto Sans Arabic','Noto Sans','DejaVu Sans','Segoe UI','Arial',sans-serif\" font-size=\"16\" font-weight=\"800\" letter-spacing=\"0\" fill",
+   },
+   Object {
+     "anchor": "end",
+     "bounds": Object {
...
- generic [ref=f2e1]:
  ...
  - generic [ref=f2e3]:
    - complementary [ref=f2e4]:
      - link "نظرة عامة" [ref=f2e6] [cursor=pointer]:
        - /url: /ar/dashboard
        - img "Waflo" [ref=f2e7]
      - button "اختيار المؤسسة" [ref=f2e9] [cursor=pointer]:
        - generic [ref=f2e14]: متجر القهوة العربية للمكافآت والولاء المحلي
      - navigation [ref=f2e17]:
        - generic [ref=f2e18]:
          - link "نظرة عامة" [ref=f2e19] [cursor=pointer]:
            - /url: /ar/dashboard
          - link "بطاقات الولاء" [ref=f2e24] [cursor=pointer]:
            - /url: /ar/dashboard/programs
          - link "العملاء" [ref=f2e29] [cursor=pointer]:
            - /url: /ar/dashboard/customers
          - link "الفروع" [ref=f2e36] [cursor=pointer]:
            - /url: /ar/dashboard/locations
          - link "الفريق" [ref=f2e41] [cursor=pointer]:
            - /url: /ar/dashboard/team
          - link "التحليلات" [ref=f2e48] [cursor=pointer]:
            - /url: /ar/dashboard/analytics
          - link "التصدير" [ref=f2e52] [cursor=pointer]:
            - /url: /ar/dashboard/exports
          - link "الفوترة والدفع" [ref=f2e57] [cursor=pointer]:
            - /url: /ar/dashboard/billing
        - generic [ref=f2e61]:
          - generic [ref=f2e62]: الحساب
          - link "الإعدادات" [ref=f2e63] [cursor=pointer]:
            - /url: /ar/dashboard/settings
          - link "الأمان" [ref=f2e68] [cursor=pointer]:
            - /url: /ar/dashboard/security
      - link "Gallery Merchant Gallery Merchant gallery@example.test" [ref=f2e75] [cursor=pointer]:
        - /url: /ar/dashboard/security
        - img "Gallery Merchant" [ref=f2e76]: GM
        - generic [ref=f2e77]:
          - strong [ref=f2e78]: Gallery Merchant
          - generic [ref=f2e79]: gallery@example.test
    - generic [ref=f2e80]:
      - banner [ref=f2e81]:
        - generic [ref=f2e82]:
          - button "اللغة" [ref=f2e84] [cursor=pointer]:
            - generic [ref=f2e89]: العربية
          - group [ref=f2e92]:
            - img "Gallery Merchant" [ref=f2e94] [cursor=pointer]: GM
      - main [ref=f2e95]:
        - generic [ref=f2e96]:
          - generic [ref=f2e97]:
            - button "بطاقات الولاء" [ref=f2e98] [cursor=pointer]
            - generic [ref=f2e101]:
              - text: إنشاء بطاقة ولاء
              - heading "خصّص بطاقة الولاء" [level=1] [ref=f2e102]
              - paragraph [ref=f2e103]: عدّل المكافأة واللغات والمظهر مع إبقاء البطاقة الحقيقية أمامك.
            - status [ref=f2e104]:
              - generic [ref=f2e109]: تم الحفظ
          - generic [ref=f2e110]:
            - generic [ref=f2e111]:
              - generic [ref=f2e112]: التصميم الأساسي
              - strong [ref=f2e113]: المحمصة الكلاسيكية
              - generic [ref=f2e114]: القهوة · كلاسيكي
            - generic [ref=f2e115]: الوضع السريع
            - button "تغيير التصميم" [ref=f2e116] [cursor=pointer]
          - generic [ref=f2e120]:
            - generic [ref=f2e121]:
              - navigation "أقسام محرر البطاقة" [ref=f2e122]:
                - button "اللغات مكتمل" [ref=f2e123] [cursor=pointer]:
                  - generic [ref=f2e129]: اللغات
                  - img "مكتمل" [ref=f2e130]
                - button "الأساسيات مكتمل" [ref=f2e132] [cursor=pointer]:
                  - generic [ref=f2e136]: الأساسيات
                  - img "مكتمل" [ref=f2e137]
                - button "المكافأة مكتمل" [ref=f2e139] [cursor=pointer]:
                  - generic [ref=f2e143]: المكافأة
                  - img "مكتمل" [ref=f2e144]
                - button "المواقع مكتمل" [ref=f2e146] [cursor=pointer]:
                  - generic [ref=f2e150]: المواقع
                  - img "مكتمل" [ref=f2e151]
                - button "المظهر مكتمل" [ref=f2e153] [cursor=pointer]:
                  - generic [ref=f2e160]: المظهر
                  - img "مكتمل" [ref=f2e161]
                - button "المراجعة والتحقق" [ref=f2e163] [cursor=pointer]
                - button "الإعدادات المتقدمة" [ref=f2e168] [cursor=pointer]
              - region [ref=f2e173]:
                - generic [ref=f2e174]:
                  - generic [ref=f2e175]:
                    - text: الوضع السريع
                    - heading "المكافأة" [level=2] [ref=f2e176]
                    - paragraph [ref=f2e177]: وضّح ما الذي سيحصل عليه العميل عند بلوغ الهدف.
                  - generic [ref=f2e178]: مكتمل
                - generic [ref=f2e179]:
                  - tablist "لغة المحتوى" [ref=f2e180]:
                    - tab "English English" [ref=f2e181] [cursor=pointer]:
                      - generic [ref=f2e182]: English
                      - generic [ref=f2e183]: English
                    - tab "العربية Arabic" [selected] [ref=f2e184] [cursor=pointer]:
                      - generic [ref=f2e185]: العربية
                      - generic [ref=f2e186]: Arabic
                  - generic [ref=f2e187]:
                    - generic [ref=f2e188]: عند اكتمال
                    - strong [ref=f2e189]: 8 ختمًا
                    - generic [ref=f2e190]: تظهر جاهزية المكافأة خارج شبكة الأختام.
                  - generic [ref=f2e191]:
                    - generic [ref=f2e192]: ما الذي سيحصل عليه العميل؟ — English *
                    - textbox "ما الذي سيحصل عليه العميل؟ — English" [ref=f2e193]: مكافأة مجانية مميزة مع اختيار مشروب وحلوى وإضافات موسمية طوال اليوم
                  - group [ref=f2e194]:
                    - generic "خيارات المكافأة" [ref=f2e195] [cursor=pointer]
                    - option "عنصر مجاني"
                    - option "خصم"
                    - option "مكافأة وصفية" [selected]
                    - option "مخصصة"
            - complementary "معاينة مباشرة" [ref=f2e196]:
              - generic [ref=f2e197]:
                - generic [ref=f2e198]:
                  - generic [ref=f2e199]:
                    - text: للمعاينة فقط
                    - heading "معاينة مباشرة" [level=2] [ref=f2e200]
                  - combobox "لغة المعاينة" [ref=f2e203]: Arabic · العربية
                - tablist "معاينة مباشرة" [ref=f2e204]:
                  - tab "Apple Legacy" [ref=f2e205] [cursor=pointer]
                  - tab "Apple iOS 27+" [active] [selected] [ref=f2e206] [cursor=pointer]
                  - tab "Google Wallet" [ref=f2e207] [cursor=pointer]
                - paragraph [ref=f2e208]: يستخدم موقع العميل عارض البطاقة المنشورة. تحاكي معاينتا Apple وGoogle مزوّد المحفظة، بينما تتحكم المحفظة في المسافات والخط النهائية.
                - tabpanel "Apple iOS 27+" [ref=f2e209]:
                  - img "Apple iOS 27+ للمعاينة فقط" [ref=f2e211]:
                    - img [ref=f2e213]:
                      - generic [ref=f2e226]:
                        - generic [ref=f2e240]:
                          - generic [ref=f2e242]: برنامج الزبائن المميز للقهوة…
                          - generic [ref=f2e243]: Preview member
                        - generic [ref=f2e246]: الأختام
                        - generic [ref=f2e247]: 0/8
                        - generic [ref=f2e253]:
                          - generic [ref=f2e254]: المكافأة
                          - generic [ref=f2e255]: مكافأة مجانية مميزة مع اختيار
                          - generic [ref=f2e256]: مشروب وحلوى وإضافات موسمية طوال…
                      - generic [ref=f2e264]: متجر القهوة العربية للم…
                - generic [ref=f2e268]:
                  - generic [ref=f2e269]: تقدم الأختام في المعاينة
                  - generic [ref=f2e270]:
                    - slider "تقدم الأختام في المعاينة" [ref=f2e271]: "0"
                    - status [ref=f2e272]: 0/8
          - button "مراجعة البطاقة" [ref=f2e274] [cursor=pointer]
```
