...
export const ar: InterfaceMessages = {
  ...
  onboarding: onboardingInterfaceCopy.ar,
  ...
  trial: {
    pending: "15 يوماً مجاناً. أضف طريقة دفع الآن، وسترى دفعتك الأولى قبل التأكيد.",
  },
  errors: {
    retry: "حاول مرة أخرى",
    back: "رجوع",
  ...
  merchant: {
    ...
    loyalty: {
      builder: {
        ...
        previewLoading: "جارٍ تحديث معاينة البطاقة المنشورة…",
        previewError: "تعذر تحديث المعاينة.",
        walletPreviewNote:
          "يستخدم موقع العميل عارض البطاقة المنشورة. تحاكي معاينتا Apple وGoogle مزوّد المحفظة، بينما تتحكم المحفظة في المسافات والخط النهائية.",
